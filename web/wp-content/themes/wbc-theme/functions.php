 ...
 * Load LACA2020 STYLE
 */
function laca2020_scripts() {
	if ( is_page_template( 'page-templates/laca2020.php' ) ) {
		wp_enqueue_style( 'laca2020', '/wp-content/themes/wbc-theme/style-laca2020.css',false );
		wp_enqueue_style( 'siteorigin-widget-icon-font-fontawesome-css', '/wp-content/plugins/so-widgets-bundle/icons/fontawesome/style.css',false );
    //wp_enqueue_script( 'script-name', get_template_directory_uri() . '/js/example.js', array(), '1.0.0', true );
	}
}
add_action( 'wp_enqueue_scripts', 'laca2020_scripts',300 );
...
function register_my_menu() {
  register_nav_menu( 'laca', __( 'LACA Menu', 'responsive-mobile' ) );
  register_nav_menu( 'laca2020', __( 'LACA 2020 Menu', 'responsive-mobile' ) );
}
...
// LACA2020 ADD text and link under page title

add_action( 'cmb2_admin_init', 'cmb2_text_link_under_title' );
/**
 * Define the metabox and field configurations.
 */
function cmb2_text_link_under_title() {

	/**
	 * Initiate the metabox
	 */
	$cmb = new_cmb2_box( array(
		'id'            => 'text_link_under_title',
		'title'         => __( 'Text and link under page title', 'cmb2' ),
		'object_types'  => array( 'page', ), // Post type
		'show_on'      => array( 'key' => 'page-template', 'value' => 'page-templates/laca2020.php' ),
		'context'       => 'normal',
		'priority'      => 'high',
		'show_names'    => true, // Show field names on the left
	) );
