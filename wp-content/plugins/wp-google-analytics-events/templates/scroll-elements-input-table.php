  ...
  <div class="wrap wpgae-gs-form">
	...
	<div class="ga_main">
        <h2 class="nav-tab-wrapper">
            <a href="?page=wp-google-analytics-events-scroll&report=true" class="nav-tab <?php if ($is_report_tab) { echo "nav-tab-active"; } ?>">Reports</a>
            <a href="?page=wp-google-analytics-events-scroll" class="nav-tab <?php if (!$is_report_tab) { echo "nav-tab-active"; } ?>">Settings</a>
        </h2>
    </div>
<?php
if ($is_report_tab) {
